...
```bash
# 进入前端目录
cd /Users/joe/ai/ai-job-seeker/frontend
...
echo $! > /Users/joe/ai/ai-job-seeker/runtime/frontend.pid
```
...
```bash
# 停止后端
kill $(cat /Users/joe/ai/ai-job-seeker/runtime/backend.pid)

# 停止前端
kill $(cat /Users/joe/ai/ai-job-seeker/runtime/frontend.pid)
...
```bash
# 后端日志
tail -f /Users/joe/ai/ai-job-seeker/backend.log

# 前端日志
tail -f /Users/joe/ai/ai-job-seeker/frontend/frontend.log
```
...
# 或导入真实数据
python3 scripts/data/import_jobs_data.py
```
...
# 停止后端
if [ -f /Users/joe/ai/ai-job-seeker/runtime/backend.pid ]; then
    kill $(cat /Users/joe/ai/ai-job-seeker/runtime/backend.pid)
    rm /Users/joe/ai/ai-job-seeker/runtime/backend.pid
    echo "后端已停止"
fi

# 停止前端
if [ -f /Users/joe/ai/ai-job-seeker/runtime/frontend.pid ]; then
    kill $(cat /Users/joe/ai/ai-job-seeker/runtime/frontend.pid)
    rm /Users/joe/ai/ai-job-seeker/runtime/frontend.pid
    echo "前端已停止"
fi
...
```bash
# 启动后端
cd /Users/joe/ai/ai-job-seeker && python3 manage.py runserver

# 启动前端
cd /Users/joe/ai/ai-job-seeker/frontend && npm run dev
